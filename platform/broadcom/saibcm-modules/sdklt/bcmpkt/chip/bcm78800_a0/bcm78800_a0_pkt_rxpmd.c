...
{
    WORD_FIELD_SET(data[3], 23, 8, val);
}

static uint32_t bcmpkt_rxpmd_src_port_num_get(uint32_t *data)
{
    uint32_t val;
    val = WORD_FIELD_GET(data[3], 23, 8);
    return val;
}
...
void bcm78800_a0_rx_reason_encode(const bcmpkt_rx_reasons_t *reasons, uint32_t *data)
{
}

void bcm78800_a0_rx_reason_decode(const uint32_t *data, bcmpkt_rx_reasons_t *reasons)
{
}

void bcm78800_a0_ep_rx_reason_encode(const bcmpkt_rx_reasons_t *reasons, uint32_t *data)
{
}

void bcm78800_a0_ep_rx_reason_decode(const uint32_t *data, bcmpkt_rx_reasons_t *reasons)
{
}

const bcmpkt_rxpmd_fget_t bcm78800_a0_rxpmd_fget = {
    {
        NULL,
...
const bcmpkt_rxpmd_fset_t bcm78800_a0_rxpmd_fset = {
    {
        NULL,
...
const bcmpkt_rxpmd_figet_t bcm78800_a0_rxpmd_figet = {
    {
...
static shr_enum_map_t bcm78800_a0_rxpmd_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm78800_a0_rxpmd_view_infos[BCMPKT_RXPMD_FID_COUNT] = {
...
void bcm78800_a0_rxpmd_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm78800_a0_rxpmd_view_infos;
    info->view_types = bcm78800_a0_rxpmd_view_types;
