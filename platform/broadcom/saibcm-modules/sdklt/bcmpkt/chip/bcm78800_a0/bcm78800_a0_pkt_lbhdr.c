 ...
 *
 * This file provides LBHDR access functions for BCM78800_A0.
 *
 ******************************************************************************/
...
const bcmpkt_lbhdr_fget_t bcm78800_a0_lbhdr_fget = {
    {
        NULL,
        NULL,
        NULL,
...
const bcmpkt_lbhdr_figet_t bcm78800_a0_lbhdr_figet = {
    {
        NULL
    }
};

static shr_enum_map_t bcm78800_a0_lbhdr_view_types[] = {
    {NULL, -1},
};
...
void bcm78800_a0_lbhdr_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm78800_a0_lbhdr_view_infos;
    info->view_types = bcm78800_a0_lbhdr_view_types;
